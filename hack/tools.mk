...
$(LOGCHECK): go.mod
	cd $(shell go list -f '{{ .Dir }}' github.com/dimitar-kostadinov/repo-tools/hack/tools/logcheck); GOTOOLCHAIN=auto CGO_ENABLED=1 go build -o $(LOGCHECK) -buildmode=plugin ./plugin
endif
